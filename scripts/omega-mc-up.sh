...
# ── 1. Gather state ────────────────────────────────────────────────────────
# OmegaMC runs in DASHBOARD mode: Mission Control web UI + the 13 AISB agents,
...
# Empty on purpose → dashboard mode (no Telegram poll; the command bot owns the token)
OMEGA_MC_TELEGRAM_TOKEN=
