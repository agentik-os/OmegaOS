...
- **14 agents, many runtimes.** AISB Matrix-named templates (Oracle, Morpheus, Seraph, Keymaker, Smith, Niobe, Neo, Zion, Link, Construct, Merovingian, Architect, Pythia, Council). Default runtime is Claude Code; Codex, Gemini, GLM, Pi, and Hermes install via `omega install` and run too.
