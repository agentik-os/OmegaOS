...
triggers: ["omg-social-content","social-content","LinkedIn post","Twitter thread","content calendar","reel","short-form video","social media"]
...
> **OmegaOS skill** — vendored from coreyhaines31/marketingskills (github.com/coreyhaines31/marketingskills). Triggers `/omg-social-content` (and `/social-content`). Governed by R-MARKETING.
