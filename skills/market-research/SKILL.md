...
triggers: ["omg-market-research","market-research","market analysis","market size","TAM","competitor research","industry research","decision makers"]
allowed-tools: ["Bash","Read","Glob","Grep","WebFetch"]
domain: marketing
read_only: false
argument-hint: "<industry or market>"
source: gooseworks-ai/goose-skills (github.com/gooseworks-ai/goose-skills)
license: see upstream repo
---

> **OmegaOS skill** — vendored from gooseworks-ai/goose-skills (github.com/gooseworks-ai/goose-skills). Triggers `/omg-market-research` (and `/market-research`). Governed by R-MARKETING. **Requires:** the gooseworks data API + ~/.gooseworks/credentials.json (provision via `npx gooseworks login`); paid per-record.
