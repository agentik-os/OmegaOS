...
triggers: ["omg-launch-strategy","launch-strategy","launch","Product Hunt","go-to-market","GTM plan","launch checklist","waitlist","feature release"]
allowed-tools: ["Read","Write","Edit","Bash","Glob","Grep","WebSearch","WebFetch"]
domain: marketing
read_only: false
argument-hint: "<what you are launching>"
source: coreyhaines31/marketingskills (github.com/coreyhaines31/marketingskills)
license: see upstream repo
---

> **OmegaOS skill** — vendored from coreyhaines31/marketingskills (github.com/coreyhaines31/marketingskills). Triggers `/omg-launch-strategy` (and `/launch-strategy`). Governed by R-MARKETING.
