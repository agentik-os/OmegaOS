...
triggers: ["omg-marketing-strategist","marketing-strategist","marketing strategy","GTM strategy","demand gen","fractional CMO","scale marketing","category creation"]
allowed-tools: ["Read","Write","Edit","Bash","Glob","Grep","WebSearch","WebFetch"]
domain: marketing
read_only: false
argument-hint: "<your company stage / goal>"
source: ncklrs/startup-os-skills (github.com/ncklrs/startup-os-skills)
license: see upstream repo
---

> **OmegaOS skill** — vendored from ncklrs/startup-os-skills (github.com/ncklrs/startup-os-skills). Triggers `/omg-marketing-strategist` (and `/marketing-strategist`). Governed by R-MARKETING.
