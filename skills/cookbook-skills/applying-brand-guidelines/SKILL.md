...
Vendored into OmegaOS from [anthropics/claude-cookbooks](https://github.com/anthropics/claude-cookbooks/tree/35f2eec/skills/custom_skills/applying-brand-guidelines) @ `35f2eec` — MIT (c) Anthropic. Upstream teaching notebooks live in `~/.omega/cookbooks/skills/notebooks/`; the routing layer is the `/cookbook` skill.
