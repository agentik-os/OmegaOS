...
**Suite position:** `53` in **06 · OWN** (Turn work into assets).

## What this OS is for

IP & Asset {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: intellectual property and durable assets: create, protect, license.
...
```bash
agentik install ip-asset-os          # install this OS
agentik configure ip-asset-os        # answer the minimum setup questions
agentik run ip-asset-os              # start using it
```
