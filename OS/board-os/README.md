...
**Suite position:** `63` in **07 · CAPITAL** (Turn assets into capital allocation).

## What this OS is for

Board {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: governance at the board level: papers, cadence, real oversight.
...
```bash
agentik install board-os          # install this OS
agentik configure board-os        # answer the minimum setup questions
agentik run board-os              # start using it
```
