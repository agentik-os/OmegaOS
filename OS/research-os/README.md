...
> General-purpose evidence gathering with sources you can defend.

**Suite position:** `12` in **02 · DISCOVER & DECIDE** (Find what is worth building).

## What this OS is for

Research {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: general-purpose evidence gathering with sources you can defend.
...
```bash
agentik install research-os          # install this OS
agentik configure research-os        # answer the minimum setup questions
agentik run research-os              # start using it
```
