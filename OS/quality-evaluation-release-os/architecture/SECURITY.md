...
- Isolate security test evidence and exploit details.
- Use sanitized or synthetic data unless production data is explicitly authorized.
- Verify artifact signatures/hashes and dependency provenance.
