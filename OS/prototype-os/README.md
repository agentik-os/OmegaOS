...
**Suite position:** `22` in **03 · BUILD** (Turn evidence into products).

## What this OS is for

Prototype {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: the cheapest artifact that answers the riskiest open question.
...
```bash
agentik install prototype-os          # install this OS
agentik configure prototype-os        # answer the minimum setup questions
agentik run prototype-os              # start using it
```
