...
- Keep private daily captures separate from approved content atoms.
- Strip secrets, customer data and location details from source material.
- Require approval before publishing, scheduling or contacting community members.
- Store licenses/consent evidence with assets.
