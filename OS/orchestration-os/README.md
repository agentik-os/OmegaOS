...
> Compose many agents and systems into one reliable mission.

**Suite position:** `71` in **08 · AI & SYSTEMS** (Intelligence infrastructure for everything).

## What this OS is for

Orchestration {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: compose many agents and systems into one reliable mission.
...
```bash
agentik install orchestration-os          # install this OS
agentik configure orchestration-os        # answer the minimum setup questions
agentik run orchestration-os              # start using it
```
