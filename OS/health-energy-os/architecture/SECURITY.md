...
- Separate medical/biometric records from general productivity context.
- Never publish or cross-share body/health data by default.
- Require explicit confirmation before persisting extracted diagnoses or medications.
