...
**Suite position:** `50` in **06 · OWN** (Turn work into assets).

## What this OS is for

Money {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: personal cash flow: what comes in, what goes out, what is left.
...
```bash
agentik install money-os          # install this OS
agentik configure money-os        # answer the minimum setup questions
agentik run money-os              # start using it
```
