...
> Recurring behaviour contracts and the evidence they actually happened.

**Suite position:** `05` in **01 · PERSONAL** (Operate yourself).

## What this OS is for

Habit Tracker {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: recurring behaviour contracts and the evidence they actually happened.
...
```bash
agentik install habit-tracker-os          # install this OS
agentik configure habit-tracker-os        # answer the minimum setup questions
agentik run habit-tracker-os              # start using it
```
