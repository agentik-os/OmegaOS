...
> Meetings that produce decisions and owners, or do not happen.

**Suite position:** `42` in **05 · OPERATE** (Turn chaos into repeatable execution).

## What this OS is for

Meeting {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: meetings that produce decisions and owners, or do not happen.
...
```bash
agentik install meeting-os          # install this OS
agentik configure meeting-os        # answer the minimum setup questions
agentik run meeting-os              # start using it
```
