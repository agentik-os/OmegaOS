...
> UX, interaction and visual design compiled into a machine-readable handoff.

**Suite position:** `21` in **03 · BUILD** (Turn evidence into products).

## What this OS is for

Design {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: ux, interaction and visual design compiled into a machine-readable handoff.
...
```bash
agentik install design-os          # install this OS
agentik configure design-os        # answer the minimum setup questions
agentik run design-os              # start using it
```
