...
> Learn distribution by selling someone else's real product.

**Suite position:** `35` in **04 · GROW** (Turn value into distribution and revenue).

## What this OS is for

Affiliate {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: learn distribution by selling someone else's real product.
...
```bash
agentik install affiliate-os          # install this OS
agentik configure affiliate-os        # answer the minimum setup questions
agentik run affiliate-os              # start using it
```
