...
> Turn scattered information into a retrievable knowledge base.

**Suite position:** `68` in **08 · AI & SYSTEMS** (Intelligence infrastructure for everything).

## What this OS is for

Knowledge {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: turn scattered information into a retrievable knowledge base.
...
```bash
agentik install knowledge-os          # install this OS
agentik configure knowledge-os        # answer the minimum setup questions
agentik run knowledge-os              # start using it
```
