...
**Suite position:** `59` in **07 · CAPITAL** (Turn assets into capital allocation).

## What this OS is for

Due Diligence {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: verify the story before you are committed to it.
...
```bash
agentik install due-diligence-os          # install this OS
agentik configure due-diligence-os        # answer the minimum setup questions
agentik run due-diligence-os              # start using it
```
