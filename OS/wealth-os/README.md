...
**Suite position:** `51` in **06 · OWN** (Turn work into assets).

## What this OS is for

Wealth {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: personal net worth, reserves and long-horizon goals.
...
```bash
agentik install wealth-os          # install this OS
agentik configure wealth-os        # answer the minimum setup questions
agentik run wealth-os              # start using it
```
