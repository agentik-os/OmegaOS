...
> Your reading and source corpus turned into retrievable understanding.

**Suite position:** `11` in **02 · DISCOVER & DECIDE** (Find what is worth building).

## What this OS is for

Librarian {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: your reading and source corpus turned into retrievable understanding.
...
```bash
agentik install librarian-os          # install this OS
agentik configure librarian-os        # answer the minimum setup questions
agentik run librarian-os              # start using it
```
