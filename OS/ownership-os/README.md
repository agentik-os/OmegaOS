...
**Suite position:** `52` in **06 · OWN** (Turn work into assets).

## What this OS is for

Ownership {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: what you own, through which entity, and on what terms.
...
```bash
agentik install ownership-os          # install this OS
agentik configure ownership-os        # answer the minimum setup questions
agentik run ownership-os              # start using it
```
