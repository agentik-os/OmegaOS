...
> Design, brief and supervise agents that do real work.

**Suite position:** `66` in **08 · AI & SYSTEMS** (Intelligence infrastructure for everything).

## What this OS is for

Agent {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: design, brief and supervise agents that do real work.
...
```bash
agentik install agent-os          # install this OS
agentik configure agent-os        # answer the minimum setup questions
agentik run agent-os              # start using it
```
