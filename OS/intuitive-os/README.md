...
> Train and calibrate intuition as a usable, falsifiable signal.

**Suite position:** `07` in **01 · PERSONAL** (Operate yourself).

## What this OS is for

Intuitive {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: train and calibrate intuition as a usable, falsifiable signal.
...
```bash
agentik install intuitive-os          # install this OS
agentik configure intuitive-os        # answer the minimum setup questions
agentik run intuitive-os              # start using it
```
