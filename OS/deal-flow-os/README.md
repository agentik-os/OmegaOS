...
**Suite position:** `58` in **07 · CAPITAL** (Turn assets into capital allocation).

## What this OS is for

Deal Flow {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: source, filter and track opportunities at the top of the funnel.
...
```bash
agentik install deal-flow-os          # install this OS
agentik configure deal-flow-os        # answer the minimum setup questions
agentik run deal-flow-os              # start using it
```
