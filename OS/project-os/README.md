...
> Scope, plan and land a project without losing the thread.

**Suite position:** `41` in **05 · OPERATE** (Turn chaos into repeatable execution).

## What this OS is for

Project {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: scope, plan and land a project without losing the thread.
...
```bash
agentik install project-os          # install this OS
agentik configure project-os        # answer the minimum setup questions
agentik run project-os              # start using it
```
