...
> Identity, voice and the visual system that carries them.

**Suite position:** `29` in **04 · GROW** (Turn value into distribution and revenue).

## What this OS is for

Brand {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: identity, voice and the visual system that carries them.
...
```bash
agentik install brand-os          # install this OS
agentik configure brand-os        # answer the minimum setup questions
agentik run brand-os              # start using it
```
