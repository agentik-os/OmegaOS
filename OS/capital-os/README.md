...
> Allocate capital deliberately across a portfolio of bets.

**Suite position:** `56` in **07 · CAPITAL** (Turn assets into capital allocation).

## What this OS is for

Capital {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: allocate capital deliberately across a portfolio of bets.
...
```bash
agentik install capital-os          # install this OS
agentik configure capital-os        # answer the minimum setup questions
agentik run capital-os              # start using it
```
