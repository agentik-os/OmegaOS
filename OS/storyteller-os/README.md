...
**Suite position:** `30` in **04 · GROW** (Turn value into distribution and revenue).

## What this OS is for

Storyteller {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: narrative truth, structure, voice and consent.
...
```bash
agentik install storyteller-os          # install this OS
agentik configure storyteller-os        # answer the minimum setup questions
agentik run storyteller-os              # start using it
```
