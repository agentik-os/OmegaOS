...
**Suite position:** `60` in **07 · CAPITAL** (Turn assets into capital allocation).

## What this OS is for

Acquisition {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: buy a business: search, approach, negotiate, close.
...
```bash
agentik install acquisition-os          # install this OS
agentik configure acquisition-os        # answer the minimum setup questions
agentik run acquisition-os              # start using it
```
