...
**Suite position:** `26` in **03 · BUILD** (Turn evidence into products).

## What this OS is for

Security {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: threat modelling, hardening and the security gate on a release.
...
```bash
agentik install security-os          # install this OS
agentik configure security-os        # answer the minimum setup questions
agentik run security-os              # start using it
```
