...
> The category you compete in and the claim you own inside it.

**Suite position:** `28` in **04 · GROW** (Turn value into distribution and revenue).

## What this OS is for

Positioning {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: the category you compete in and the claim you own inside it.
...
```bash
agentik install positioning-os          # install this OS
agentik configure positioning-os        # answer the minimum setup questions
agentik run positioning-os              # start using it
```
