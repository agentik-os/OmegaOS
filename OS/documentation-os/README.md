...
**Suite position:** `43` in **05 · OPERATE** (Turn chaos into repeatable execution).

## What this OS is for

Documentation {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: write it once, find it later, keep it true.
...
```bash
agentik install documentation-os          # install this OS
agentik configure documentation-os        # answer the minimum setup questions
agentik run documentation-os              # start using it
```
