...
**Suite position:** `34` in **04 · GROW** (Turn value into distribution and revenue).

## What this OS is for

Sales {OS} is one operative system of the AGENTIK {OS} suite. It is not a
...
Use it when your problem is: pipeline, conversations and the close, without manipulation.
...
```bash
agentik install sales-os          # install this OS
agentik configure sales-os        # answer the minimum setup questions
agentik run sales-os              # start using it
```
